    ...
    return /*html*/ `
      ...
      <html lang="en">
        <head>
          ...
          <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${webview.cspSource}; script-src 'nonce-${nonce}' http://localhost:* 'unsafe-eval'; connect-src 'self' ws://localhost:8072/ http://localhost:*;  ">
